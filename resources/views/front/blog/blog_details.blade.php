            ...
            <div class="row">
                <div class="col-lg-8 py-100">
                    <div class="border rounded bg-white">
                        <img class="img-fluid w-100 rounded-top" src="{{asset($blog->blog_image)}}" alt="blog-image">
                        <div class="p-4">
...
{{--                                    deserunt mollit anim id est laborum.Sed ut perspiciatis unde omnis.</p>--}}
                            ...
                            <div class="row mb-20">
                                <div class="col-sm-5 pr-sm-0 align-self-center">
                                    <img class="img-fluid w-100 rounded mr-4 mb-4 mb-sm-0" src="images/blog/blog-testimonial.jpg"
                                         alt="client image">
                                </div>
                                <div class="col-sm-7">
