            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-7">
                    <div class="p-5 rounded box-shadow">
                        <form action="{{route('message_submit')}}" method="post" class="row">
                            @csrf
                            <div class="col-12">
                                <h3>Contact Form</h3>
                            </div>
                            ...
                            <div class="col-12">
                                <textarea class="form-control p-2" name="message"  placeholder="Your Message Here..." required style="height: 150px;"></textarea>
                            </div>
                            <div class="col-12">
